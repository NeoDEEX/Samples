...
public partial class MainForm : XtraForm
{
    ...
    private static FoxDataServiceClient CreateDataClient(string uri)
    {
        return new FoxDataServiceClient(uri);
    }
    ...
    {
        using (var client = CreateDataClient("api/dataservice"))
        {
    ...
    private async Task LegacyUpdateImpl()
    {
        ...
        await DoUpdate("Legacy.UpdateProducts", dt);
    }
    ...
    private async Task UpdateUsingAmbientValuedParameter()
    {
        ...
        await DoUpdate("Ambient.UpdateProducts", dt);
    }
