...
CREATE OR REPLACE PROCEDURE get_categories (cur OUT SYS_REFCURSOR) AS
BEGIN
  OPEN cur FOR SELECT * FROM categories WHERE category_id <= 3;
END;
...
INSERT INTO categories VALUES (1, 'Beverages', 'Soft drinks, coffees, teas, beers, and ales', EMPTY_BLOB());
INSERT INTO categories VALUES (2, 'Condiments', 'Sweet and savory sauces, relishes, spreads, and seasonings', EMPTY_BLOB());
INSERT INTO categories VALUES (3, 'Confections', 'Desserts, candies, and sweet breads', EMPTY_BLOB());
INSERT INTO categories VALUES (4, 'Dairy Products', 'Cheeses', EMPTY_BLOB());
INSERT INTO categories VALUES (5, 'Grains/Cereals', 'Breads, crackers, pasta, and cereal', EMPTY_BLOB());
INSERT INTO categories VALUES (6, 'Meat/Poultry', 'Prepared meats', EMPTY_BLOB());
INSERT INTO categories VALUES (7, 'Produce', 'Dried fruit and bean curd', EMPTY_BLOB());
INSERT INTO categories VALUES (8, 'Seafood', 'Seaweed and fish', EMPTY_BLOB());
